...
export function writePNGtext(image, key, value, mode = "tEXt") {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const imageArr = yield cast2Uint8Array(image);
 ...
 * @throws {TypeError} If a marker is invalid
 */
export function writeWebpXMP(image, value) {
    return __awaiter(this, void 0, void 0, function* () {
        typeCheck(value, ["string"]);
        const imageArr = yield cast2Uint8Array(image);
        ...
        yield img.load(imageArr);
        img.xmp = new TextEncoder().encode(value);
        const data = yield img.save(null, { xmp: true });
        return data;
    });
}
/**
 ...
 */
function cast2Uint8Array(blob) {
    return __awaiter(this, void 0, void 0, function* () {
        typeCheck(blob, [Blob, Uint8Array]);
        if (blob instanceof Uint8Array) {
            return blob;
        }
        const buffer = yield new Response(blob).arrayBuffer();
 ...
 */
export function readPNGtext(image, key) {
    return __awaiter(this, void 0, void 0, function* () {
        typeCheck(key, ["string"]);
        const imageArr = yield cast2Uint8Array(image);
        if ((yield getMimeType(imageArr)) !== "image/png") {
...
* @throws {TypeError} If a marker is invalid
*/
export function readWebpXMP(image) {
    return __awaiter(this, void 0, void 0, function* () {
        const imageArr = yield cast2Uint8Array(image);
        if ((yield getMimeType(imageArr)) !== "image/webp") {
